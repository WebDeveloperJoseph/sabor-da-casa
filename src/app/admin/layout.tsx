...
export default function AdminLayout({
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-orange-50 via-gray-50 to-red-50">
      ...
      <div className="fixed inset-y-0 left-0 w-16 sm:w-20 md:w-64 lg:w-72 bg-gradient-to-br from-white to-orange-50/30 shadow-xl border-r border-orange-100 z-30 backdrop-blur-sm">
        {/* Header da Sidebar */}
        <div className="flex items-center justify-center h-20 md:h-28 px-2 md:px-6 border-b border-orange-200 bg-gradient-to-br from-orange-500 to-red-500 relative overflow-hidden">
            ...
            {menuItems.map((item) => {
              ...
              return (
                <Link
                  key={item.href}
                  href={item.href}
                  className="flex items-center justify-center md:justify-start px-2 md:px-4 py-3.5 text-sm font-medium rounded-xl text-gray-700 hover:bg-gradient-to-r hover:from-orange-500 hover:to-red-500 hover:text-white hover:shadow-lg transition-all duration-200 group"
                  title={item.label}
                >
                  <Icon className="w-5 h-5 md:mr-3 text-gray-500 group-hover:text-white transition-colors flex-shrink-0" />
        ...
        {/* Voltar para site */}
        <div className="absolute bottom-0 left-0 right-0 p-2 md:p-4 bg-gradient-to-t from-white to-transparent border-t border-orange-100">
          <Link
            href="/"
